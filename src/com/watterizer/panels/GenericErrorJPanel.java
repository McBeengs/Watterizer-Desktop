...
public class GenericErrorJPanel extends javax.swing.JPanel {

    private OpaqueScreen rootPane;
    ...
    public GenericErrorJPanel(OpaqueScreen rootPane, String title, int messageType, String message, int type) throws ArrayIndexOutOfBoundsException {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(errorTitle);
        errorTitle.setBounds(0, 24, 570, 50);
        ...
        add(retryButton);
        retryButton.setBounds(352, 410, 180, 22);

        leftButton.setText("jButton1");
        leftButton.setFocusPainted(false);
        leftButton.setFocusable(false);
        add(leftButton);
        leftButton.setBounds(350, 450, 85, 22);

        rightButton.setText("jButton2");
        rightButton.setFocusPainted(false);
        rightButton.setFocusable(false);
        add(rightButton);
        rightButton.setBounds(450, 450, 85, 22);
